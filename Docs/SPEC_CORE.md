...
Monolith.uplugin
  ...
  MonolithAnimation     — Animation sequences, montages, ABPs, curves, notifies, skeletons, PoseSearch, ABP/ControlRig write, anim-graph-authoring pack, layout (~170+ actions)
...
>
> **Ballpark, current:** **~1,500+ actions across 25+ in-tree namespaces** (query `monolith_discover()` for the live figure — see Action Count Discipline in `monolith-release.md`).
