...
bool FMonolithIndexRecoveryLifecycleTest::RunTest(const FString& /*Parameters*/)
{
	...
	TestEqual(TEXT("a fresh database is schema v4"), Fixture.Database.ReadMeta(TEXT("schema_version")), FString(TEXT("4")));
	...
	TestEqual(TEXT("a reset restates the schema version"),
		Fixture.Database.ReadMeta(TEXT("schema_version")), FString(TEXT("4")));
...
bool FMonolithIndexRecoverySchemaMigrationTest::RunTest(const FString& /*Parameters*/)
{
	...
	TestEqual(TEXT("the schema version is stamped 4"),
		Fixture.Database.ReadMeta(TEXT("schema_version")), FString(TEXT("4")));
